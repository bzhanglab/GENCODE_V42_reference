...
These scripts were developed to prepare a GENCODE V42-based reference for proteogenomics data processing and downstream analysis for the [CPTAC](https://proteomics.cancer.gov/programs/cptac) community. 
